// ============================================================================
// File: modified-readandbuild-rust_for_iRT-removedCache/src/utils.rs
// ============================================================================
...
// ============================================================================
// 板块2: TimsTOF核心read_timstof_data + 新增辅助函数 build_scan_lookup 
// ============================================================================
...
pub fn read_timstof_data(d_folder: &Path) -> Result<TimsTOFRawData, Box<dyn Error>> {
    ...
    // 按窗口排序以获得一致的输出
    ms2_vec.sort_by_key(|((low, high), _)| ((low * 10000.0) as u32, (high * 10000.0) as u32));
...
// ============================================================================
// 板块7: MS1/MS2数据构建函数（与改版文件完全相同）
// ============================================================================

// [所有build_ms1_data, build_ms2_data, build_precursor_info, format_ms_data, build_lib_matrix函数与改版文件完全相同]
...
// ============================================================================
// 板块8: 矩阵构建和处理函数（与改版文件完全相同）
// ============================================================================

// [所有矩阵处理函数与改版文件完全相同，包括：
// build_precursors_matrix_step1, build_precursors_matrix_step2, 
// extract_width_2, build_range_matrix_step3, extract_width, 
...
// ============================================================================
// 板块9: Polars和DataFrame处理函数（与改版文件完全相同）
// ============================================================================

// [所有DataFrame处理函数与改版文件完全相同]
...
// ============================================================================
// 板块11: UniqueValues提取函数（与改版文件完全相同）
// ============================================================================
